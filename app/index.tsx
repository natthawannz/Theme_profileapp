    ...
    <SafeAreaView style={[styles.container, { backgroundColor: T.BG }]}>
      ...
      <View style={[styles.details, { backgroundColor: T.CARD }]}>
        <Text style={[styles.label, { color: T.ACCENT }]}>
          คณะ <Text style={{ color: T.TEXT }}>{profile.faculty}</Text>
        </Text>
        <Text style={[styles.label, { color: T.ACCENT }]}>
          หลักสูตร <Text style={{ color: T.TEXT }}>{profile.course}</Text>
        </Text>
        <Text style={[styles.label, { color: T.ACCENT }]}>
          มหาวิทยาลัย <Text style={{ color: T.TEXT }}>{profile.university}</Text>
        </Text>
      </View>
